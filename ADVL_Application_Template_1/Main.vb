...
#Region " Coding Notes - Notes on the code used in this class." '==============================================================================================================================
    ...
    'Run the ADVL_Message_Service_1 application to start the message service.
...
'The follwing lines show the code sections used in the Main form of an Andorville™ application:
