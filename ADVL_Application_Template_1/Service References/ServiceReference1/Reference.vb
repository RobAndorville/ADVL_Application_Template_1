...
Namespace ServiceReference1
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0"),  _
     System.Runtime.Serialization.DataContractAttribute(Name:="clsConnection.enumAppType", [Namespace]:="http://schemas.datacontract.org/2004/07/WcfMsgServiceLib")>  _
    Public Enum clsConnectionenumAppType As Integer
    ...
    Public Interface IMsgService
        ...
        Function Connect(ByVal appName As String, ByVal appType As ServiceReference1.clsConnectionenumAppType, ByVal getAllWarnings As Boolean, ByVal getAllMessages As Boolean) As Boolean
        
        <System.ServiceModel.OperationContractAttribute(Action:="http://tempuri.org/IMsgService/Connect", ReplyAction:="http://tempuri.org/IMsgService/ConnectResponse")>  _
        Function ConnectAsync(ByVal appName As String, ByVal appType As ServiceReference1.clsConnectionenumAppType, ByVal getAllWarnings As Boolean, ByVal getAllMessages As Boolean) As System.Threading.Tasks.Task(Of Boolean)
    ...
    Partial Public Class MsgServiceClient
        ...
        Public Function Connect(ByVal appName As String, ByVal appType As ServiceReference1.clsConnectionenumAppType, ByVal getAllWarnings As Boolean, ByVal getAllMessages As Boolean) As Boolean Implements ServiceReference1.IMsgService.Connect
            Return MyBase.Channel.Connect(appName, appType, getAllWarnings, getAllMessages)
        End Function
        
        Public Function ConnectAsync(ByVal appName As String, ByVal appType As ServiceReference1.clsConnectionenumAppType, ByVal getAllWarnings As Boolean, ByVal getAllMessages As Boolean) As System.Threading.Tasks.Task(Of Boolean) Implements ServiceReference1.IMsgService.ConnectAsync
